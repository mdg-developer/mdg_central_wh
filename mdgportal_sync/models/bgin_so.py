                    ...
                    if sale_order_id.origin.startswith("BRFI"):
                        ...
                        if bgin_id:
                            ...
                            for line in self.move_ids_without_package:
                                issue_qty =0
                                factor = line.product_id.uom_po_id.factor_inv
                                if factor != 0:
                                    issue_qty = line.quantity_done/factor

                                # BGIN Issue Syncing
                                change_bgin_line_id = models.execute_kw(db, sd_uid, password, 'branch.good.issue.note.line','search', [[['line_id', '=', bgin_id[0]],['product_id.default_code', '=',line.product_id.default_code]]],{'limit' :1})
                                value = {
