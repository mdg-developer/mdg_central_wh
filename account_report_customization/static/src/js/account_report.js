...
var _t = core._t;
    ...
    accountReportsWidget.include({
        ...
        render_searchview_buttons: function() {
            ...
            if (this.report_options.account_ids) {
                ...
                if (!this.M2MCustomAccountFilters) {
                    ...
                    if (!_.isEmpty(fields)) {
                        ...
                        this.M2MCustomAccountFilters.appendTo(this.$searchview_buttons.find('.js_account_account_m2m'));
                    }
                } else {
                    this.$searchview_buttons.find('.js_account_account_m2m').append(this.M2MCustomAccountFilters.$el);
                }
            }
